...
\begin{table}[t]
\centering\footnotesize
\caption{音色评估：频谱质心区分度（$n=10$/风格，10 秒/首）}
\label{tab:timbre_eval}
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Style Expert} & \textbf{Avg. Centroid (Hz)} & \textbf{Std. Dev. (Hz)} & \textbf{$\Delta$\% vs. Prec.} \\
\midrule
Erhu (String)  & 1689 & 382 & ---   \\
Dizi (Wind)    & 2132 & 223 & +26\%  \\
Suona (Brass)  & 2720 & 683 & +28\%  \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Style Expert} & \textbf{Target BPM} & \textbf{Detected BPM} & \textbf{Rhythm Obedience} \\
\midrule
