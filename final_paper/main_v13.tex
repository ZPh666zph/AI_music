...
% ═══════════════════════════════════════════════════════════
\title{\bfseries\Large Multi-Viewpoint Structural Prompting for\\[2pt] Controllable Music Generation via Hot-Pluggable MoE}
\author[1]{作者一}
\author[2]{作者二}
\author[1]{作者三}
\affil[1]{XX大学 · 计算机学院}
...
\setlength{\tabcolsep}{3pt}% 缩小列间距，使最后两列靠近
...
\label{tab:timbre_eval_delta} % 新增标签，原标签未改
\begin{tabular}{@{}lc@{}}
\toprule
...
\label{tab:rhythm_eval_obey} % 新增标签，原标签未改
\begin{tabular}{@{}lc@{}}
\toprule
