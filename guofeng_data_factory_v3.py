...
OUT_DIR     = Path("C:/Deepseek/outputs/guofeng_v3")
...
PIPELINES = [
    {
        "name": "erhu",
        "style_expert": "string",
        "sf2": Path("C:/Deepseek/soundfonts/guzheng.sf2"),  # 二胡
        "gm_replacement_program": 40,   # Violin → Erhu
    },
    {
        "name": "dizi",
        "style_expert": "wind",
        "sf2": Path("C:/Deepseek/soundfonts/Dizi.sf2"),     # 笛子
        "gm_replacement_program": 73,   # Flute → Dizi
    },
    {
        "name": "suona",
        "style_expert": "brass",
        "sf2": Path("C:/Deepseek/soundfonts/BrightTrombone.sf2"),  # 长号平替唢呐
